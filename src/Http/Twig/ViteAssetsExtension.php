...
class ViteAssetsExtension extends AbstractExtension
{
    ...
    public function __construct(string $assetPath, string $env, CacheItemPoolInterface $cache, RequestStack $requestStack)
    {
    ...
    public function link(string $name): string
    {
        ...
        if (strpos($uri, ':3000')) {
            return '';
        // Le CSS est chargé depuis le JS dans l'environnement de dev
        }
